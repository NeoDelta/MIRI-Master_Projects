...
unsigned int gFBO, gPos, gNormals, depthRBO, ssaoFBO, ssao, noiseTex, screenQuadVAO, screenQuadVBO;
...
void GLWidget::CreateSSAOSamples() {
  ...
  for(unsigned int i = 0; i < numSamples; i++) {
    ...
    Eigen::Vector3f sample(
                ...
                randomFloats(generator)                     //Upper hemisphere
    );
